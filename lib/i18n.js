...
const translations = {
  de: {
    ...
    togglePreview: 'Vorschau umschalten (⌘P)',

    // Format context menu
    formatCut: 'Ausschneiden',
    formatCopy: 'Kopieren',
    formatPaste: 'Einfügen',
    formatBold: 'Fett',
    formatItalic: 'Kursiv',
    formatCode: 'Code',
    ...
    formatCodeText: 'Code',
    formatStrikethroughText: 'Text',
    formatLinkLabel: 'Linktext'
  },
  ...
  en: {
    ...
    togglePreview: 'Toggle preview (⌘P)',
  ...
  fr: {
    ...
    togglePreview: 'Basculer l\'aperçu (⌘P)',
    ...
    formatList: 'Liste',
    formatTask: 'Tâche',
    formatBoldText: 'Texte',
    formatItalicText: 'Texte',
    formatCodeText: 'Code',
    formatStrikethroughText: 'Texte',
    formatLinkLabel: 'Texte du lien'
  },
  ...
  es: {
    ...
    togglePreview: 'Alternar vista previa (⌘P)',
    ...
    formatList: 'Lista',
    formatTask: 'Tarea',
    formatBoldText: 'Texto',
    formatItalicText: 'Texto',
    formatCodeText: 'Código',
    formatStrikethroughText: 'Texto',
    formatLinkLabel: 'Texto del enlace'
  }
};
